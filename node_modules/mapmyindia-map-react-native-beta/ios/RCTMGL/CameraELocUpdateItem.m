...
{
    if (_cameraStop.mode == [NSNumber numberWithInt:RCT_MAPBOX_CAMERA_MODE_FLIGHT] && _cameraStop.eLoc != nil) {
        [self _flyToCamera:mapView withCompletionHandler:completionHandler];
    } else if (_cameraStop.mode == [NSNumber numberWithInt:RCT_MAPBOX_CAMERA_MODE_EASE] && _cameraStop.eLoc != nil) {
        [self _moveCamera:mapView animated:YES withCompletionHandler:completionHandler];
    } else if (_cameraStop.eLocBounds != nil) {
...
- (void)_flyToCamera:(RCTMGLMapView*)mapView withCompletionHandler:(void (^)(void))completionHandler
{
    ...
    MapmyIndiaMapView *mmiMapView = mapView;
...
//    };
    MapmyIndiaMapView *mmiMapView = mapView;
    [mmiMapView showElocs:_cameraStop.eLocBounds animated:true completionHandler:nil];
...
- (MGLMapCamera*)_makeCamera:(RCTMGLMapView*)mapView
{
    ...
    if (_cameraStop.eLoc != nil) {
        nextCamera.centerEloc = _cameraStop.eLoc;
    }
