...
- (void)setReactELoc:(NSString *)reactELoc
{
    _reactELoc = reactELoc;
    [self updateEloc:reactELoc completionHandler:nil];
//    self.eLoc = reactELoc;
}
...
- (void)_addAnnotation
{
    ...
    MapmyIndiaMapView *mmiMapView = _map;
    
    [mmiMapView addMapmyIndiaAnnotation: self completionHandler:nil];
    if (_reactSelected) {
        [_map selectAnnotation:self animated:NO completionHandler:nil];
    }
}
