...
- (NSDictionary<NSString *, id> *)constantsToExport
{
    ...
    [styleURLS setObject:@"https://apis.mapmyindia.com/vector_map/style/style.json" forKey:@"Light"];
    [styleURLS setObject:@"https://apis.mapmyindia.com/vector_map/style/mapmyindia_nightmode.json" forKey:@"Dark"];
    [styleURLS setObject:@"https://apis.mapmyindia.com/vector_map/style/mapmyindia_hybrid.json" forKey:@"SatelliteStreet"];
    ...
    [eventTypes setObject:RCT_MAPMYINDIA_STYLES_LIST_LOADED forKey:@"DidLoadedMapmyIndiaMapsStyles"];
...
{
    [MapmyIndiaAccountManager setMapSDKKey:mapSDKKey];
}

RCT_EXPORT_METHOD(setRestAPIKey:(NSString *)restAPIKey)
{
    [MapmyIndiaAccountManager setRestAPIKey:restAPIKey];
}

RCT_EXPORT_METHOD(setAtlasClientId:(NSString *)atlasClientId)
{
    [MapmyIndiaAccountManager setAtlasClientId:atlasClientId];
}

RCT_EXPORT_METHOD(setAtlasClientSecret:(NSString *)atlasClientSecret)
{
    [MapmyIndiaAccountManager setAtlasClientSecret:atlasClientSecret];
}

RCT_EXPORT_METHOD(setAtlasGrantType:(NSString *)atlasGrantType)
{
    [MapmyIndiaAccountManager setAtlasGrantType:atlasGrantType];
}

RCT_EXPORT_METHOD(setDeveloperShowingSplash:(BOOL *)showDeveloperSplash)
{
    [MapmyIndiaAccountManager setIsHiddenAuthorizationFailOverlay: showDeveloperSplash];
}

RCT_EXPORT_METHOD(setShowLastSelectedStyle: (BOOL *)showLastSelectedStyle)
{
    [MapmyIndiaMapConfiguration setIsShowPreferedMapStyle:showLastSelectedStyle];
}

RCT_EXPORT_METHOD(isShowLastSelectedStyle:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    bool showSelectedStyle = [MapmyIndiaMapConfiguration isShowPreferedMapStyle];
...
RCT_EXPORT_METHOD(settingClusterId: (NSString *) clusterId deviceAlias:(NSString *)deviceAlias) {
    if(deviceAlias == nil) {
        [MapmyIndiaAccountManager setClusterId:clusterId];
    } else {
        [MapmyIndiaAccountManager setClusterId:clusterId linkedDeviceAlias:deviceAlias];
    }
}

RCT_EXPORT_METHOD(setRegion:(NSString *)region)
{
  [MapmyIndiaAccountManager setDefaultRegion:region];
}

//RCT_EXPORT_METHOD(setClusterId: (NSString *) clusterId) {
//    [MapmyIndiaAccountManager setClusterId: clusterId];
//}

RCT_EXPORT_METHOD(getClusterId: (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    resolve([MapmyIndiaAccountManager clusterId]);
    
}

//RCT_EXPORT_METHOD(setDefaultRegion:(MMIRegionTypeIdentifier *)region)
//{
//    [MapmyIndiaAccountManager setDefaultRegion:region];
//}
...
{
    [MapmyIndiaAccountManager setIndoorEnabled:enabled];
}

RCT_EXPORT_METHOD(setUsingRasterStyle:(BOOL *)enabled) {
    [MapmyIndiaAccountManager setTileEncryptionEnabled:!enabled];
}

RCT_EXPORT_METHOD(setIndoorDefaultUIEnabled:(BOOL *)enabled)
{
    [MapmyIndiaAccountManager setIndoorDefaultUIEnabled:enabled];
}

RCT_EXPORT_METHOD(setAssociationId:(NSString *)associationId)
{
    [MapmyIndiaAccountManager setAssociationId: associationId];
}

RCT_EXPORT_METHOD(setDefaultDistanceUnit:(MapmyIndiaDistanceUnit *)unit)
{
    [MapmyIndiaAccountManager setDefaultDistanceUnit:unit];
}

RCT_EXPORT_METHOD(getMapSDKKey:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject)
{
    NSString *mapSDKKey = MapmyIndiaAccountManager.mapSDKKey;
...
{
    NSString *restAPIKey = MapmyIndiaAccountManager.restAPIKey;
...
{
    NSString *atlasClientId = MapmyIndiaAccountManager.atlasClientId;
...
{
    NSString *atlasClientSecret = MapmyIndiaAccountManager.atlasClientSecret;
...
RCT_EXPORT_METHOD(getAtlasGrantType:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject)
{
    NSString *atlasGrantType = MapmyIndiaAccountManager.atlasGrantType;

    if (atlasGrantType != nil) {
        resolve(atlasGrantType);
        return;
    }

    reject(@"missing_atlasGrantType", @"No atlasGrantType has been set", nil);
}

//RCT_EXPORT_METHOD(getDefaultRegion:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject)
//{
//    MMIRegionTypeIdentifier *defaultRegion = MapmyIndiaAccountManager.defaultRegion;
//
...
//    }
//
//    reject(@"missing_defaultRegion", @"No defaultRegion has been set", nil);
//}

//RCT_EXPORT_METHOD(getIndoorEnabled:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject)
//{
//    BOOL *indoorEnabled = MapmyIndiaAccountManager.indoorEnabled;
//
//    if (indoorEnabled != nil) {
//        resolve(indoorEnabled);
//        return;
//    }
//
//    reject(@"missing_defaultRegion", @"No defaultRegion has been set", nil);
...
//RCT_EXPORT_METHOD(getIndoorDefaultUIEnabled:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject)
//{
//    BOOL *indoorDefaultUIEnabled = MapmyIndiaAccountManager.indoorDefaultUIEnabled;
//
//    if (indoorDefaultUIEnabled != nil) {
//        resolve(indoorDefaultUIEnabled);
//        return;
//    }
//
//    reject(@"missing_defaultRegion", @"No defaultRegion has been set", nil);
...
//RCT_EXPORT_METHOD(getDefaultDistanceUnit:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject)
//{
//    MapmyIndiaDistanceUnit *defaultDistanceUnit = MapmyIndiaAccountManager.defaultDistanceUnit;
//
//    if (defaultDistanceUnit != nil) {
//        resolve(defaultDistanceUnit);
//        return;
//    }
//
//    reject(@"missing_defaultDistanceUnit", @"No defaultDistanceUnit has been set", nil);
//}
