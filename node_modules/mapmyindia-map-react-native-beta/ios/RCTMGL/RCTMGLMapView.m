...
- (void)setReactLayerControlEnabled:(BOOL)reactLayerControlEnabled
{
    _reactLayerControlEnabled = reactLayerControlEnabled;
    self.layerControlEnabled = reactLayerControlEnabled;
}

- (void)setReactLayerControlPosition:(NSDictionary<NSString *,NSNumber *> *)reactLayerControlPosition
{
    NSNumber *left   = [reactLayerControlPosition valueForKey:@"left"];
    NSNumber *right  = [reactLayerControlPosition valueForKey:@"right"];
    NSNumber *top    = [reactLayerControlPosition valueForKey:@"top"];
    NSNumber *bottom = [reactLayerControlPosition valueForKey:@"bottom"];
    if (left != nil) {
        [self setIndoorSelecorViewLeftConstraintConstant: [left floatValue]];
    } else if (bottom != nil) {
        [self setIndoorSelecorViewBottomConstraintConstant: [bottom floatValue]];
    } else if (right != nil) {
...
- (void)setReactStyleURL:(NSString *)reactStyleURL
{
    ...
    if(_reactStyleURL != nil) {
    [self _removeAllSourcesFromMap];
    self.styleURL = [self _getStyleURLFromKey:_reactStyleURL];
    }
}

- (void)setReactMapmyIndiaStyle:(NSString *)reactMapmyIndiaStyle {
    _reactMapmyIndiaStyle = reactMapmyIndiaStyle;
    if(_reactMapmyIndiaStyle != nil) {
    [self _removeAllSourcesFromMap];
    [self setMapmyIndiaMapsStyle:_reactMapmyIndiaStyle];
    }
}
