...
@interface RCTMGLMapViewManager() <MapmyIndiaMapViewDelegate>
@end
...
NSArray<MapmyIndiaMapStyle *> *styleList;
...
RCT_REMAP_VIEW_PROPERTY(layerControlEnabled, reactLayerControlEnabled, BOOL)
RCT_REMAP_VIEW_PROPERTY(layerControlPosition, reactLayerControlPosition, NSDictionary)
...
RCT_REMAP_VIEW_PROPERTY(mapmyIndiaStyle, reactMapmyIndiaStyle, NSString)
...
RCT_EXPORT_VIEW_PROPERTY(onDidLoadedMapmyIndiaMapsStyles, RCTBubblingEventBlock)
...
- (void)didLoadedMapmyIndiaMapsStyles:(MapmyIndiaMapView *)mapView styles:(NSArray<MapmyIndiaMapStyle *> *)styles withError:(NSError *)error {
    if(error == nil) {
        styleList = styles;
    }
}
- (void)mapView:(MapmyIndiaMapView *)mapView authorizationCompleted:(BOOL)isSuccess withError:(NSError *)error
{
    RCTMGLMapView* reactMapView = ((RCTMGLMapView *) mapView);
    if(!isSuccess) {
...
{
    RCTMGLMapView* reactMapView = ((RCTMGLMapView *) mapView);
    RCTMGLMapStyleListEvent *event = [RCTMGLMapStyleListEvent mapmyIndiaStyles: reactMapView styles:styleList];
    [self fireEvent:event withCallback:reactMapView.onDidLoadedMapmyIndiaMapsStyles];
...
//    reactMapView.symbolAnnotationController = [[MGLSymbolAnnotationController alloc]initWithMapView:mapView];
