...
@interface RCTMGLMapView : MapmyIndiaMapView<RCTInvalidating>
...
//@property (nonatomic, strong) MGLSymbolAnnotationController *symbolAnnotationController;
...
@property (nonatomic, assign) BOOL reactLayerControlEnabled;
@property (nonatomic, strong) NSDictionary<NSString *, NSNumber *> *reactLayerControlPosition;
...
@property (nonatomic, copy) NSString *reactMapmyIndiaStyle;
...
@property (nonatomic, copy) RCTBubblingEventBlock onDidLoadedMapmyIndiaMapsStyles;
