...
export type MapmyIndiaGLEvent<
  T extends string,
  P = GeoJSON.Feature,
  V = Element
> = SyntheticEvent<V, {type: T; payload: P}>;

declare namespace MapmyIndiaGL {
  ...
  function setMapSDKKey(mapSdkKey: string): void;
  function setAtlasGrantType(atlasGrantType: string): void;
  ...
  function setDeveloperShowingSplash(developerShowingSplash: boolean): void;
  function setUsingRasterStyle(usingRasterStyle: boolean): void;
  function setShowLastSelectedStyle(showLastStyle: boolean): void;
  function isShowLastSelectedStyle(): Promise<boolean>
  function setClusterId(clusterId: string,deviceAlias?: string): void;
  function getClusterId(): Promise<string>;
  function setAssociationId(phoneNumber:string):void;
...
interface NearbyProps {
  keyword:string,
  location :String,//"lng,lat" or "eLoc"
  page?:number,
  sort?:string,
  radius?:number,
  pod?:string,
...
interface POIAlongRouteProps {
 ...
 interface DeleteClusterLinkedDeviceProps {
  linkedDevice: String;
  clusterId: String;
  sessionType?: String;
 }

 interface ClusterLinkedDevicesProps {
  clusterId: String;
  sessionType?: String;
 }
  ...
  namespace RestApi {
    function autoSuggest(props: AutoSuggestProps):Promise<any>;
    function reverseGeocode(props: RevGeoCodeProps):Promise<any>;
    function geocode(props: GeoCodeProps):Promise<any>;
    function textSearch(props: TextSearchProps):Promise<any>;
    function placeDetail(props: PlaceDetailsProps):Promise<any>;
    function placeDetailLegacy(props: PlaceDetailsProps):Promise<any>;
    function nearby(props: NearbyProps):Promise<any>;
    function direction(props: DirectionProps):Promise<any>;
    function distance(props: DistanceProps):Promise<any>;
    function POIAlongRoute(props: POIAlongRouteProps):Promise<any>;
    function feedback(props: FeedbackProps):Promise<any>;
    function mapmyIndiaClusterLinkedDevices(props: ClusterLinkedDevicesProps):Promise<any>;
    function mapmyIndiaDeleteClusterLinkedDevice(props:DeleteClusterLinkedDeviceProps):Promise<any>;
    function mapmyIndiaEndSession(props: ClusterLinkedDevicesProps):Promise<any>;
  }
  ...
  class Camera extends Component<CameraProps> {
    ...
    fitBoundsWithEloc(
      eLocBounds: Array<String>,
      padding?: Padding,
      duration?: number,
    ): void;
    flyTo(coordinates: GeoJSON.Position, duration?: number): void;
    moveTo(coordinates: GeoJSON.Position, duration?: number): void;
    flyWithEloc(eLoc: String, duration?: number): void;
    moveWithEloc(eLoc: String, duration?: number): void;
...
export interface MapViewProps extends ViewProps {
  animated?: boolean;
  userTrackingMode?: MapmyIndiaGL.UserTrackingModes;
  userLocationVerticalAlignment?: number;
  contentInset?: Array<number>;
  style?: StyleProp;
  /**
   * @deprecated This props should not be used
   */
  styleURL?: string;
  mapmyIndiaStyle?: string;
  ...
  onMapError?:(featur: MapmyIndiaGL.MapError) => void
  didLoadedMapmyIndiaMapsStyles?:(feature: Array<MapmyIndiaGL.MapmyIndiaStyle>) => void
  ...
  onUserLocationUpdate?: (feature: MapmyIndiaGL.Location) => void;
...
export interface UserLocationProps {
  ...
  visible?: boolean;
  onPress?: () => void;
  onUpdate?: (location: MapmyIndiaGL.Location) => void;
  children?: ReactNode;
...
export interface VectorSourceProps extends TileSourceProps {
  onPress?: (event: MapmyIndiaGLEvent<'vectorsourcelayerpress'>) => void;
  hitbox?: {
    width: number;
    height: number;
  };
...
export interface ShapeSourceProps extends ViewProps {
  ...
  onPress?: (event: MapmyIndiaGLEvent<'shapesourcelayerpress'>) => void;
  hitbox?: {
    width: number;
    height: number;
  };
...
export interface LayerBaseProps<T = {}> extends Omit<ViewProps, 'style'> {
  id?: string;
  sourceID?: MapmyIndiaGL.StyleSource;
...
export interface OfflineCreatePackOptions {
  name?: string;
  styleURL?: MapmyIndiaGL.StyleURL;
  bounds?: [GeoJSON.Position, GeoJSON.Position];
  minZoom?: number;
  maxZoom?: number;
  metadata?: any;
