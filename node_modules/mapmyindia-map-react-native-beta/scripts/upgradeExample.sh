...
react-native init RNMapmyIndiaGLExample
mv example/src RNMapmyIndiaGLExample/src
mv example/scripts RNMapmyIndiaGLExample/scripts
rm -rf example
mv RNMapmyIndiaGLExample example
