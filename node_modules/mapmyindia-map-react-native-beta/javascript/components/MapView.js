...
class MapView extends NativeBridgeComponent(React.Component) {
  static propTypes = {
    ...
    /**
     * @deprecated Style URL for map
     */
    styleURL: PropTypes.string,

    /**
     * MapmyIndia Style for map
     */
    mapmyIndiaStyle: PropTypes.string,
     ...
     */
    didLoadedMapmyIndiaMapsStyles: PropTypes.func,
  ...
  static defaultProps = {
    ...
    logoEnabled: true,
    // styleURL: MapmyIndiaGL.StyleURL.Light,
    surfaceView: false,
  ...
  constructor(props) {
    ...
    this._didLoadedMapmyIndiaMapsStyles = this._didLoadedMapmyIndiaMapsStyles.bind(this);
  ...
  _setHandledMapChangedEvents(props) {
    if (isAndroid()) {
      ...
      if (props.onRegionWillChange)
        events.push(MapmyIndiaGL.EventTypes.RegionWillChange);
      if (props.onRegionIsChanging)
        events.push(MapmyIndiaGL.EventTypes.RegionIsChanging);
      if (props.onRegionDidChange)
        events.push(MapmyIndiaGL.EventTypes.RegionDidChange);
      if (props.onUserLocationUpdate)
        events.push(MapmyIndiaGL.EventTypes.UserLocationUpdated);
      if (props.onWillStartLoadingMap)
        events.push(MapmyIndiaGL.EventTypes.WillStartLoadingMap);
      if (props.onDidFinishLoadingMap)
        events.push(MapmyIndiaGL.EventTypes.DidFinishLoadingMap);
      if (props.onDidFailLoadingMap)
        events.push(MapmyIndiaGL.EventTypes.DidFailLoadingMap);
      if (props.onWillStartRenderingFrame)
        events.push(MapmyIndiaGL.EventTypes.WillStartRenderingFrame);
      if (props.onDidFinishRenderingFrame)
        events.push(MapmyIndiaGL.EventTypes.DidFinishRenderingFrame);
      if (props.onDidFinishRenderingFrameFully)
        events.push(MapmyIndiaGL.EventTypes.DidFinishRenderingFrameFully);
      if (props.onWillStartRenderingMap)
        events.push(MapmyIndiaGL.EventTypes.WillStartRenderingMap);
      if (props.onDidFinishRenderingMap)
        events.push(MapmyIndiaGL.EventTypes.DidFinishRenderingMap);
      if (props.onDidFinishRenderingMapFully)
        events.push(MapmyIndiaGL.EventTypes.DidFinishRenderingMapFully);
      if (props.onDidFinishLoadingStyle)
        events.push(MapmyIndiaGL.EventTypes.DidFinishLoadingStyle);
  ...
  _createStopConfig(config = {}) {
    const stopConfig = {
      mode: isNumber(config.mode) ? config.mode : MapmyIndiaGL.CameraModes.Ease,
      pitch: config.pitch,
  ...
  _didLoadedMapmyIndiaMapsStyles(e) {
    if (isFunction(this.props.didLoadedMapmyIndiaMapsStyles)) {
      this.props.didLoadedMapmyIndiaMapsStyles(e.nativeEvent.payload.mapmyindia_styles);
    }
  }
  ...
  _onChange(e) {
    ...
    switch (type) {
      case MapmyIndiaGL.EventTypes.RegionWillChange:
        ...
        break;
      case MapmyIndiaGL.EventTypes.RegionIsChanging:
        propName = 'onRegionIsChanging';
        break;
      case MapmyIndiaGL.EventTypes.RegionDidChange:
        ...
        break;
      case MapmyIndiaGL.EventTypes.UserLocationUpdated:
        propName = 'onUserLocationUpdate';
        break;
      case MapmyIndiaGL.EventTypes.WillStartLoadingMap:
        propName = 'onWillStartLoadingMap';
        break;
      case MapmyIndiaGL.EventTypes.DidFinishLoadingMap:
        propName = 'onDidFinishLoadingMap';
        break;
      case MapmyIndiaGL.EventTypes.DidFailLoadingMap:
        propName = 'onDidFailLoadingMap';
        break;
      case MapmyIndiaGL.EventTypes.WillStartRenderingFrame:
        propName = 'onWillStartRenderingFrame';
        break;
      case MapmyIndiaGL.EventTypes.DidFinishRenderingFrame:
        propName = 'onDidFinishRenderingFrame';
        break;
      case MapmyIndiaGL.EventTypes.DidFinishRenderingFrameFully:
        propName = 'onDidFinishRenderingFrameFully';
        break;
      case MapmyIndiaGL.EventTypes.WillStartRenderingMap:
        propName = 'onWillStartRenderingMap';
        break;
      case MapmyIndiaGL.EventTypes.DidFinishRenderingMap:
        propName = 'onDidFinishRenderingMap';
        break;
      case MapmyIndiaGL.EventTypes.DidFinishRenderingMapFully:
        propName = 'onDidFinishRenderingMapFully';
        break;
      case MapmyIndiaGL.EventTypes.DidFinishLoadingStyle:
  ...
  render() {
    ...
    const callbacks = {
      ...
      onDidLoadedMapmyIndiaMapsStyles:this._didLoadedMapmyIndiaMapsStyles,
