...
const MapmyIndiaGLSnapshotManger = NativeModules.MGLSnapshotModule;
...
class SnapshotManager {
   ...
   * const uri = await MapmyIndiaGL.snapshotManager.takeSnap({
  ...
  takeSnap(options = {}) {
    ...
    return new Promise(async (resolve, reject) => {
      try {
        const uri = await MapmyIndiaGLSnapshotManger.takeSnap(snapshotOptions);
        resolve(uri);
      } catch (e) {
        reject(e);
      }
