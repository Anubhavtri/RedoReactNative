...
public class RCTMGLCamera extends AbstractMapFeature {
    ...
    private void setInitialCamera() {
        if (mDefaultStop != null) {
            ...
            if(mDefaultStop.isELocStrategyEnabled()) {
             CameraELocUpdateItem item = mDefaultStop.toCameraELocUpdate(mMapView.getMapboxMap());
             item.run();
            } else {
    ...
    private void updateLocationLayer() {
        if (mLocationComponent == null) {
            ...
            mLocationComponent.activateLocationComponent(mContext,locationComponentOptions);
