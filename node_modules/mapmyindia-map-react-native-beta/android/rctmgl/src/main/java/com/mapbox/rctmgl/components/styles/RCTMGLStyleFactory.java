...
public class RCTMGLStyleFactory {
    ...
    public static void setSymbolLayerStyle(final SymbolLayer layer, final RCTMGLStyle style) {
      List<String> styleKeys = style.getAllStyleKeys();
        System.out.println("setSymbolLayerStyle");
      if (styleKeys.size() == 0) {
        return;
      }
            ...
            case "iconImage":
              ...
              style.addImage(styleValue, new DownloadMapImageTask.OnAllImagesLoaded() {
                  ...
                  public void onAllImagesLoaded() {
                      ...
                      System.out.println("onAllImagesLoaded");
