...
public class RCTMGLModule extends ReactContextBaseJavaModule {
    ...
    public Map<String, Object> getConstants() {
        ...
        styleURLS.put("Light", Style.STREETS);
        styleURLS.put("Dark", Style.NIGHT_MODE);
        styleURLS.put("SatelliteStreet", Style.HYBRID);
    ...
    public void setRestAPIKey(final String restAPIKey) {
        mReactContext.runOnUiQueueThread(new Runnable() {
            @Override
            public void run() {
                MapmyIndiaAccountManager.getInstance().setRestAPIKey(restAPIKey);
            }
        });
    }
    ...
    public void setMapSDKKey(final String mapSDKKey) {
        mReactContext.runOnUiQueueThread(new Runnable() {
            @Override
            public void run() {
                MapmyIndiaAccountManager.getInstance().setMapSDKKey(mapSDKKey);
            }
        });
    }

    @ReactMethod
    public void setAtlasGrantType(final String atlasGrantType) {
        mReactContext.runOnUiQueueThread(new Runnable() {
            @Override
            public void run() {
                MapmyIndiaAccountManager.getInstance().setAtlasGrantType(atlasGrantType);
            }
        });
    }
    ...
    public void setAtlasClientId(final String atlasClientId) {
        mReactContext.runOnUiQueueThread(new Runnable() {
            @Override
            public void run() {
                MapmyIndiaAccountManager.getInstance().setAtlasClientId(atlasClientId);
            }
        });
    }
    ...
    public void setDeveloperShowingSplash(final boolean developerShowingSplash) {
        mReactContext.runOnUiQueueThread(new Runnable() {
            @Override
            public void run() {
                MapmyIndiaAccountManager.getInstance().setDeveloperShowingSplash(developerShowingSplash);
            }
        });
    }
    ...
    public void setAtlasClientSecret(final String atlasClientSecret) {
        mReactContext.runOnUiQueueThread(new Runnable() {
            @Override
            public void run() {
                MapmyIndiaAccountManager.getInstance().setAtlasClientSecret(atlasClientSecret);
            }
        });
    }
    ...
    public void setRegion(final String region) {
        mReactContext.runOnUiQueueThread(new Runnable() {
            @Override
            public void run() {
                MapmyIndiaAccountManager.getInstance().setRegion(region);
            }
        });
    }
    ...
    @ReactMethod
    public void setAssociationId(final String phoneNumber) {
        mReactContext.runOnUiQueueThread(new Runnable() {
            @Override
            public void run() {
                MapmyIndiaAccountManager.getInstance().setAssociationId(phoneNumber);
            }
        });
    }
    ...
    public void setUsingRasterStyle(final boolean usingRasterStyle) {
        mReactContext.runOnUiQueueThread(new Runnable() {
            @Override
            public void run() {
                MapmyIndiaAccountManager.getInstance().setUsingRasterStyle(usingRasterStyle);
            }
        });
    }
    ...
    public void initialize() {
        mReactContext.runOnUiQueueThread(new Runnable() {
            @Override
            public void run() {
                MapmyIndia.getInstance(getReactApplicationContext());
            }
        });
    }
    ...
    public void getAccessToken(Promise promise) {
        ...
        map.putString("accessToken", MapmyIndia.getAccessToken());
        promise.resolve(map);
    }

   /* @ReactMethod
    public void setClusterId(final String clusterId) {
        Log.e("test","Only cluster");
        mReactContext.runOnUiQueueThread(new Runnable() {
            @Override
            public void run() {
                MapmyIndia.setClusterID(clusterId);
            }
        });
    }*/

    @ReactMethod
    public void settingClusterId(final String clusterId, final String deviceAlias) {
        mReactContext.runOnUiQueueThread(new Runnable() {
            @Override
            public void run() {
                if (deviceAlias == null){
                    ...
                    MapmyIndia.setClusterID(clusterId,deviceAlias);
                }
            }
        });
    }
    ...
    public void getClusterId(Promise promise) {
        promise.resolve(MapmyIndia.getClusterID());
    }
    ...
    public void setTelemetryEnabled(final boolean telemetryEnabled) {
        mReactContext.runOnUiQueueThread(new Runnable() {
            @Override
            public void run() {
//                TelemetryDefinition telemetry = MapmyIndia.getTelemetry();
//                telemetry.setUserTelemetryRequestState(telemetryEnabled);
    ...
    public void setConnected(final boolean connected) {
        mReactContext.runOnUiQueueThread(new Runnable() {
            @Override
            public void run() {
                MapmyIndia.setConnected(connected);
            }
        });
    }
    ...
    public void setShowLastSelectedStyle(final boolean showLastStyle) {
        mReactContext.runOnUiQueueThread(new Runnable() {
            @Override
            public void run() {
                MapmyIndiaMapConfiguration.getInstance().setShowLastSelectedStyle(showLastStyle);
            }
        });
    }
    ...
    public void isShowLastSelectedStyle(Promise promise) {
        promise.resolve(MapmyIndiaMapConfiguration.getInstance().isShowLastSelectedStyle());
    }
