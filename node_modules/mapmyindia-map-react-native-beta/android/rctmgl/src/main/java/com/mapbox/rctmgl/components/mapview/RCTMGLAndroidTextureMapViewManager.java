...
public class RCTMGLAndroidTextureMapViewManager extends RCTMGLMapViewManager {
    ...
    protected RCTMGLAndroidTextureMapView createViewInstance(ThemedReactContext themedReactContext) {
        MapmyIndiaMapOptions options =  MapmyIndiaMapOptions.createFromAttributes(themedReactContext, null);

        options.layerControlMargins(options.getLogoMargins());
        options.layerControlGravity(options.getLogoGravity());
//        options.styleUrl(Style.STREETS);
