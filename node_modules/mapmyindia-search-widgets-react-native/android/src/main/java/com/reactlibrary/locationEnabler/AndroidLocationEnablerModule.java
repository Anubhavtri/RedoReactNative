package com.reactlibrary.locationEnabler;
 ...
 * @since 2016-12
 */
public class AndroidLocationEnablerModule extends ReactContextBaseJavaModule implements ActivityEventListener, OnCompleteListener<LocationSettingsResponse> {

    private static final String SELF_MODULE_NAME = "AndroidLocationEnabler";
    ...
    private static final String TAG = AndroidLocationEnablerModule.class.getName();
    ...
    public void onActivityResult(Activity activity, int requestCode, int resultCode, Intent data) {
        if (requestCode == REQUEST_CHECK_SETTINGS && promise != null) {
            if (resultCode == RESULT_OK || isLocationProviderEnabled()) {
                ...
                promise.reject(ERR_USER_DENIED_CODE, new AndroidLocationEnablerException("denied"));
            }
            this.promise = null;
        }
    }
            ...
            switch (exception.getStatusCode()) {
                case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                    try {
                        ...
                        if (promise != null) promise.reject(ERR_FAILED_OPEN_DIALOG_CODE, new AndroidLocationEnablerException("Failed to show dialog", sendEx));
                        this.promise = null;
                    } catch (ClassCastException classCast) {
                        if (promise != null) promise.reject(ERR_INTERNAL_ERROR, new AndroidLocationEnablerException("Internal error", classCast));
                        this.promise = null;
                    }
                    break;
                case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                    if (promise != null) promise.reject(ERR_SETTINGS_CHANGE_UNAVAILABLE_CODE, new AndroidLocationEnablerException("Settings change unavailable"));
                    this.promise = null;
                    break;
            }
        }
