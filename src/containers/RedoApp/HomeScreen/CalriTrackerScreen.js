...
const CalriTrackerScreen = props => {
  ...
  var firstdayCall =  new Date(firstdayOfWeek.setDate(firstdayOfWeek.getDate())).toISOString();
  ...
  var lastdayCall =new Date(firstdayOfWeek.setDate(firstdayOfWeek.getDate()+1)).toISOString();
   var weekTotalSteps =
    parseFloat(sunDaySteps) +
    parseFloat(monDaySteps) +
      parseFloat(tueDaySteps) +
        parseFloat( wedDaySteps) +
          parseFloat(thuDaySteps) +
            parseFloat( friDaySteps) +
              parseFloat(satDaySteps);
 ...
 const opt = {
   ...
   await GoogleFit.getDailyCalorieSamples(opt).then((res) => {
    console.log("res calll :"+JSON.stringify(res));
    setdailySteps(res[0]?.calorie.toFixed(2)??0);
  });
   } 
   const getWeeklyUserSetps = async ()=>{
    const opt = {
      startDate: firstdayCall, // required
      endDate: lastdayCall, // required
      basalCalculation: true, // optional, to calculate or not basalAVG over the week
      bucketUnit:"DAY", // optional - default "DAY". Valid values: "NANOSECOND" | "MICROSECOND" | "MILLISECOND" | "SECOND" | "MINUTE" | "HOUR" | "DAY"
      bucketInterval: 1, // optional - default 1. 
    };
    console.log("opt : "+JSON.stringify(opt))
     await GoogleFit.getDailyCalorieSamples(opt).then((res) => {
      console.log("res calll 222:"+JSON.stringify(res));
      setSunDaySteps(res[0]?.calorie.toFixed(2)??0);
      setmonDaySteps(res[1]?.calorie.toFixed(2)??0);
      settueDaySteps(res[2]?.calorie.toFixed(2)??0);
      setwedDaySteps(res[3]?.calorie.toFixed(2)??0);
      setthuDaySteps(res[4]?.calorie.toFixed(2)??0);
      setfriDaySteps(res[5]?.calorie.toFixed(2)??0);
      setsatDaySteps(res[6]?.calorie.toFixed(2)??0);
    });
   }
    const backAction = () => {
      ...
      <View style={styles.mainContainer}>
        <View style={styles.secCon}>
          ...
          <View style={styles.headCon}>
            <Text style={styles.txtHead}>Calories</Text>
          </View>
          ...
          <View>
            <View style={styles.graphCon}>
              ...
              <View style={styles.stpCon}>
                <Text style={styles.stpTxt}>{dailySteps} Calories</Text>
              </View>
              <View style={styles.avgCon}>
            ...
            <View style={styles.totalCon}>
              <Text style={styles.totTxt}>Total Calories</Text>
            ...
            <View style={styles.spaceCon}>
              <View style={styles.bxCon}>
                ...
                <View style={styles.fontCons}>
                  <Text style={styles.dateTxt}>{dailySteps} Calories </Text>
                  {/* <TouchableOpacity onPress={() => navigate(Screens.SETSELECTGOALS)} style={styles.setbtnCon}>
            ...
            <View style={styles.graphCon}>
              ...
              <View style={styles.stpCon}>
                <Text style={styles.stpTxt}>
                  {Math.round(averageSteps)} Calories
                </Text>
              </View>
              <View style={styles.avgCon}>
            ...
            {sunDaySteps != 0 ? (
              <View style={styles.spaceCon}>
                <View style={styles.bxCon}>
                  ...
                  <View style={styles.fontCons}>
                    <Text style={styles.dateTxt}>{sunDaySteps} Calories</Text>
            ...
            {monDaySteps != 0 ? (
              <View style={styles.spaceCon}>
                <View style={styles.bxCon}>
                  ...
                  <View style={styles.fontCons}>
                    <Text style={styles.dateTxt}>{monDaySteps} Calories</Text>
                    {/* <Text style={styles.dateTxt}>63%</Text> */}
                  </View>
                </View>
              </View>
            ...
            {tueDaySteps != 0 ? (
              <View style={styles.spaceCon}>
                <View style={styles.bxCon}>
                  ...
                  <View style={styles.fontCons}>
                    <Text style={styles.dateTxt}>{tueDaySteps} Calories</Text>
                    {/* <Text style={styles.dateTxt}>63%</Text> */}
                  </View>
                </View>
              </View>
            ...
            {wedDaySteps != 0 ? (
              <View style={styles.spaceCon}>
                <View style={styles.bxCon}>
                  ...
                  <View style={styles.fontCons}>
                    <Text style={styles.dateTxt}>{wedDaySteps} Calories</Text>
                    {/* <Text style={styles.dateTxt}>63%</Text> */}
                  </View>
                </View>
              </View>
            ...
            {thuDaySteps != 0 ? (
              <View style={styles.spaceCon}>
                <View style={styles.bxCon}>
                  ...
                  <View style={styles.fontCons}>
                    <Text style={styles.dateTxt}>{thuDaySteps} Calories</Text>
                    {/* <Text style={styles.dateTxt}>63%</Text> */}
                  </View>
                </View>
              </View>
            ...
            {friDaySteps != 0 ? (
              <View style={styles.spaceCon}>
                <View style={styles.bxCon}>
                  ...
                  <View style={styles.fontCons}>
                    <Text style={styles.dateTxt}>{friDaySteps} Calories</Text>
                    {/* <Text style={styles.dateTxt}>63%</Text> */}
                  </View>
                </View>
              </View>
            ...
            {satDaySteps != 0 ? (
              <View style={styles.spaceCon}>
                <View style={styles.bxCon}>
                  ...
                  <View style={styles.fontCons}>
                    <Text style={styles.dateTxt}>{satDaySteps} Calories</Text>
                    {/* <Text style={styles.dateTxt}>63%</Text> */}
                  </View>
                </View>
              </View>
...
export default CalriTrackerScreen;
