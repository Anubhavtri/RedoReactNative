...
export const SetGoalsWithStep = (props) => {
        ...
        if (weight == null || weight == '') {
          alert('Select your weight');
              ...
              var getResult = ""
                ...
                getResult = await POSTApi(locations.CREATE_USER,body,props?.token)
              if(getResult.error){
               setSpinnerShow(false)
               alert(getResult.message)
              }else {
  ...
  const setFinalGoal = async() => {
    console.log("result dailyStep: "+dailyStep)
            ...
            <View style={styles.mainContainer}>
             <Spinner visible={spinnerShow}></Spinner>
                ...
                <FlatList
                    ...
                    showsHorizontalScrollIndicator={false}
                    renderItem={({ item, intex }) => (
                        <TouchableOpacity onPress={() => { setNewWeight(item.name,item.value) }} style={{flexDirection : 'column',width : 150,height :50,paddingLeft :20,justifyContent : 'center'}}>
                ...
                {type == 'Lose Weight' && (<Text style={{ color: '#707070',  fontSize: 13, fontFamily: 'Jost-Medium',textAlign : 'center'}}>Easy pace to sustain, you will be trying to losse 250 cal/day</Text>)}
                {type == 'Gain Weight' && (<Text style={{ color: '#707070',  fontSize: 13, fontFamily: 'Jost-Medium',textAlign : 'center'}}>Easy pace to sustain, you will be trying to gain 250 cal/day</Text>)}
                </View>
                <View style={styles.spaceCon3}>
...
const mapStateToProps = state => ({
  ...
  export default connect(mapStateToProps, mapDispatchToProps)(SetGoalsWithStep);
