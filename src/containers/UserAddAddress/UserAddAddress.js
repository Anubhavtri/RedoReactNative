...
export const UserAddAddress = (props) => {
                        ...
                        <View style={[styles.Bodyformbox, styles.paddingClass]}>
                            <View style={[styles.Bodyform]}>
                                ...
                                <TextInput
                                    ...
                                    onChangeText={(value) => {
                                        if (!car.test(value)) {
                                            setbookingerrormsg("Invalid name")
                                        } else {
                                            setbookingerrormsg("")
                                        }
                                    ...
                                    {bookingerrormsg ?
                                <Text style={styles.errormesasge}>{bookingerrormsg}</Text> : null}
                            </View>
                        </View>
                        {namemessage || bookingerrormsg ? null :
...
export default connect(mapStateToProps, mapDispatchToProps)(UserAddAddress)
