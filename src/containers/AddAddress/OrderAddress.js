...
export const OrderAddress = (props) => {
    ...
    const Address = ({ Addressstate }) => {
        console.log(Addressstate, "hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh")
        return (
            Addressstate.map((item) => {
                console.log(item , "gggggggggggggggggggggggggggggg")
                return (
        ...
        <SafeAreaView style={styles.MainContainer}>
            <View style={styles.TopNav}>
                <MaterialCommunityIcons
                    ...
                    backgroundColor="#3b5998"
                />
                <Text style={styles.topnavtext}>Order Address</Text>
            </View>
